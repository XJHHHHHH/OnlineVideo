                                        ...
                                        <nav class="mt-2" aria-label="Page navigation example ">
                                            <ul class="pagination justify-content-center">
                                                <li class="page-item ${userList.hasPreviousPage?"":"disabled"}">
                                                    <a class="page-link" href="/admin/user?pageNum=${userList.prePage}" tabindex="-1">上一页</a>
                                                </li>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="addModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="/admin/add" onsubmit="return registSubmit()">
                    <div class="modal-header">
                        <h5 class="modal-title" id="registModalLabel">添加</h5>
